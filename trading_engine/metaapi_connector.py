...
class MetaApiRateLimitError(MetaApiError):
    """
    Levée quand MetaApi renvoie 429 (Too Many Requests).
    L'orchestrateur peut la reconnaître spécifiquement pour mettre en pause
    au lieu de continuer à bombarder.
    """
    pass
